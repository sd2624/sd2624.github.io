...
// 질문 목록
const questions = [
    "현재 귀하의 연령대가 어떻게 되시나요?",
    "월평균 소득이 350만원 미만이신가요?",
    "현재 임대주택에 거주하고 계신가요?",
    "가구 구성원이 몇 명이신가요?",
    "현재 직장에 다니고 계신가요?",
    "기초생활수급자이신가요?",
...
const results = [
    [
        "최대 70만원 상당의 지원금 수령 가능! (90~100점)",
        "귀하는 다음과 같은 지원금을 받으실 수 있습니다:",
        "1. 생활안정지원금: 월 30만원",
        "2. 주거비지원: 월 20만원",
        "3. 광역자치단체 특별지원금: 월 20만원",
        "신청 방법:",
        "1. 복지로 사이트 방문: <a href='http://www.bokjiro.go.kr' target='_blank'>www.bokjiro.go.kr</a>",
        "2. 주민센터 방문 신청",
        "3. 정부24 온라인 신청: <a href='http://www.gov.kr' target='_blank'>www.gov.kr</a>"
    ],
    [
        "환급 가능성이 있습니다. (75~89점)",
...
document.querySelectorAll('.kakao-share').forEach(button => {
    button.addEventListener('click', () => {
        Kakao.Link.sendDefault({
            objectType: 'feed',
            content: {
                title: '자동차 수리비 20% 환급받는 사람들의 비결!',
                description: '당신도 자동차 수리비 20% 환급 대상자일 수 있습니다!',
