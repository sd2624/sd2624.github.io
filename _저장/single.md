...
<head>
  ...
  <script>
    ...
    window.addEventListener('load', function() {
        ...
        // 광고 표시 지연 처리
        setTimeout(function() {
            document.querySelector('.anchor-ad-top').style.display = 'block';
            document.querySelector('.anchor-ad-bottom').style.display = 'block';
        }, 2000);  // 2초 후 광고 로드
    });
  </script>
...
<body>
  ...
  <!-- 상단 고정 광고 -->
  <div class="anchor-ad-top" style="display:none;">
    <ins class="adsbygoogle"
  ...
  <!-- 하단 고정 광고 -->
  <div class="anchor-ad-bottom" style="display:none;">
    <ins class="adsbygoogle"
    style="display:inline-block;width:728px;height:90px"
    data-ad-client="ca-pub-9374368296307755"
  ...
  window.onload = function() {
    ...
    // 1분에서 2분 사이의 랜덤 딜레이 설정
    let randomDelay = Math.floor(Math.random() * (120000 - 12000 + 1)) + 12000;
    ...
    setTimeout(function showPopup() {
        ...
        incrementClickCount(); // 팝업이 표시된 후 카운트 증가
    }, randomDelay);
    ...
    function shouldShowPopup() {
        ...
        // 하루에 한 번만 팝업 표시
        return clickData.date !== currentDate || clickData.count < 1;
    }
