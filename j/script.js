...
const questions = [
    "만 19세 이상이신가요?",
    "도시에서 1년 이상 거주하셨나요?",
    "귀농·귀촌 교육을 받으실 의향이 있나요?",
    "6개월 이상 농촌 체험이 가능하신가요?",
    "가족과 함께 이주 가능하신가요?",
    "농사 체험에 관심이 있으신가요?",
    "현재 직장을 퇴직하셨거나 예정인가요?",
    "기초 농업 교육을 이수하셨나요?",
    "정부 지원 사업 신청이 처음이신가요?",
    "귀농·귀촌 계획이 구체적으로 있으신가요?"
];

const results = [
    [
        "귀농·귀촌 지원사업 대상자입니다! (90~100점)",
        "귀하는 다음과 같은 혜택을 받으실 수 있습니다:",
        "1. 정착 지원금: 월 30만원(최대 6개월)",
        "2. 주거 지원: 무상 숙소 제공",
        "3. 교육 지원: 영농 기술 교육 무료 제공",
        "신청 방법:",
        "1. 귀농귀촌종합센터 방문: <a href='http://www.returnfarm.com' target='_blank'>www.returnfarm.com</a>",
        "2. 농림수산식품교육문화정보원: <a href='http://www.epis.or.kr' target='_blank'>www.epis.or.kr</a>",
        "3. 지자체 농업기술센터 상담"
    ],
    [
        "환급 가능성이 있습니다. (75~89점)",
...
document.querySelectorAll('.kakao-share').forEach(button => {
    button.addEventListener('click', () => {
        Kakao.Link.sendDefault({
            objectType: 'feed',
            content: {
                title: '농촌에서 살아보기! 매월 30만원 지원금 받기',
                description: '귀농·귀촌 체험 프로그램 신청하고 새로운 삶을 시작하세요!',
