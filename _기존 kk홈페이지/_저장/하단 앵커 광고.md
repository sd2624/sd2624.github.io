...
<head>
    ...
    <style>
        .anchor-ad-top {
            ...
            top: 0;
            left: 50%;
            transform: translateX(-50%) scale(0.5); /* 중앙 정렬 및 50% 크기로 축소 */
        ...
        /* 광고 크기에 맞춘 상단 및 하단 여백 */
        body {
            padding-top: 45px; /* 상단 고정 광고에 맞춘 여백 */
            padding-bottom: 45px; /* 하단 고정 광고에 맞춘 여백 */
        }
    </style>
</head>
<body>
