...
const results = [
    [
        "최대 7만원 숙박 할인 혜택 가능! (90~100점)",
        "귀하는 숙박 할인권 수령 대상자입니다:",
        "1. 주중 숙박 할인: 최대 4만원",
        "2. 연박 추가 할인: 최대 3만원",
        "신청 방법:",
        "1. 관광공사 회원가입: <a href='http://www.visitkorea.or.kr' target='_blank'>www.visitkorea.or.kr</a>",
        "2. 할인쿠폰 발급: <a href='http://www.vacation.kr' target='_blank'>www.vacation.kr</a>",
        "3. 지역별 숙소 예약: <a href='http://www.staycation.kr' target='_blank'>www.staycation.kr</a>"
    ],
    [
        "환급 가능성이 있습니다. (75~89점)",
...
document.querySelectorAll('.kakao-share').forEach(button => {
    button.addEventListener('click', () => {
        Kakao.Link.sendDefault({
            objectType: 'feed',
            content: {
                title: '정부 숙박 할인권으로 알뜰하게 여행가자!',
                description: '최대 7만원 숙박비 할인 받고 여행 떠나기',
