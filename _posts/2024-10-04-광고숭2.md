      ...
      <section class="page__content" itemprop="text">
        ...
        <div class="in-content-ad">
            <ins class="adsbygoogle"
                 style="display:block; margin: auto; text-align: center; padding: 20px 0;"
...
<div id="adContainer">
  <div class="ad-content">
      <div class="ad-counter">
          <span id="adCounter">광고가 7초 후에 닫힐 수 있습니다...</span>
          <button id="closeAdButton" style="display:none;" onclick="closeAd()">닫기</button>
      </div>
      <!-- 광고 영역 -->
      <ins class="adsbygoogle"
