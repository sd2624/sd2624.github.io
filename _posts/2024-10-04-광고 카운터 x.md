...
<!-- 하단 고정 광고 영역 -->
<div id="fixedAd" style="overflow: hidden;">
    <ins class="adsbygoogle"
         style="display:block; width:100%; height:0.1px !important; line-height: 0.1px;"
         data-ad-client="ca-pub-9374368296307755"
         data-ad-slot="9952845435"
         data-ad-format="auto"
         data-full-width-responsive="true"></ins>
    <button id="closeFixedAd" onclick="closeFixedAd()">X</button>
</div>

<script>
    // 페이지 로드 시 광고 항상 고정
    window.onload = function() {
        document.getElementById('fixedAd').style.display = 'block'; // 항상 보이게 설정
    };
...
<style>
    #fixedAd {
        display: block; /* 페이지 로드 시 항상 표시 */
        position: fixed;
        bottom: 0;
        left: 0;
        width: 100%;
        height: 0.1px; /* 광고 높이를 50px로 제한 */
